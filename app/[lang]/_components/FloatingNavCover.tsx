...
const FloatingNavCover = ({
    ...
    return (
        <div
            ...
            <a href={ticketUrl}
               className="inline-flex justify-center items-center mx-auto py-3 px-3 gt-lg:px-10 gt-lg:w-52 lt-sm:w-72 text-base font-medium text-center text-white rounded-lg bg-amber-900 hover:bg-amber-950 focus:bg-amber-950 animate-pulse">
                {lang === "en" ? "Get Tickets" : "Billets"}
