        ...
        <div className="container" style={{backgroundColor: "#ffecde"}}>
            ...
            <div className={"grid grid-cols-12 gap-4"}>
                <div className={"col-start-3 col-span-9 lt-sm:col-start-2 lt-sm:col-span-10 gt-lg:col-start-4 gt-lg:col-span-8 space-y-6"}>
                    <div className="text-center"><div className={"text-3xl"}>WHAT IS McGameJam?</div></div>
                    ...
                    <br />
                    <div className={"text-center text-3xl"}>F.A.Q.</div>
                    <div className={"text-md"}>
                    ...
                    <div className="flex items-center justify-center">
                        <button className="relative bg-amber-600 p-4 rounded-lg shadow-lg hover:bg-amber-700">
                            <div className="absolute top-0 right-0 bg-red-500 text-xs text-white py-0.5 px-1.5 transform translate-x-1/2 -translate-y-1/2 rounded-md">
                                Early birds 25% off
                            </div>
